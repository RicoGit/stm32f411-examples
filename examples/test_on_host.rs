...
//! host.
//!
//! 1. Comment `target = "thumbv7em-none-eabihf"` in /cargo/config.toml
//! 2. Build for MCU `cargo build --example test_on_host --target thumbv7em-none-eabihf`
//! 3. Run test with std `cargo test --example test_on_host`
